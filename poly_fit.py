...
if __name__ == '__main__':
    ...
    show_polyfit("./test_images/test1.jpg", visualize, save_examples)
    show_polyfit("./test_images/test2.jpg", visualize, save_examples)
    show_polyfit("./test_images/test3.jpg", visualize, save_examples)
    show_polyfit("./test_images/test4.jpg", visualize, save_examples)
    show_polyfit("./test_images/test5.jpg", visualize, save_examples)
    show_polyfit("./test_images/test6.jpg", visualize, save_examples)
